...
public class DeleteMyReview {
    ...
    void setParent(ManageMyReview parent) { this.parent = parent; }
    ...
    void updateStarPoint()
    {
    	...
    	res.setRestaurantID(Integer.parseInt(review[4]));
    	try
		{
